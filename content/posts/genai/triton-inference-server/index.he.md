...
description = 'חמש תובנות פרקטיות מפרודקשן על איפה Triton מצטיין, איפה פחות, ואיך שומרים על לטנטיות ואמינות.'

[social]
image = 'social.png'
image_alt = 'תמונת שיתוף עם לקחים מעשיים להגשת מודלי למידת מכונה באמצעות Triton Inference Server.'
