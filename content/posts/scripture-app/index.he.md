...
draft = false
description = 'למה בחרתי לא לבנות הלאה אפליקציה לשינון כתבי קודש, גם כשהשוק נראה מבטיח על הנייר.'

[social]
image = 'social.png'
image_alt = 'תמונת שיתוף לרפלקציה יזמית על התאמת שוק, זהות אישית, והבחירה לא להמשיך לבנות מוצר.'
